...
//
	...
	@Operation(summary = "DB 연결 확인용", description = "연결 테스트함", tags = { "EgovMberManageApiController" })
		@GetMapping(value = "/dbtest")
		public ResultVO selectDbTest()
				throws Exception {


			Map<String, Object> resultMap = new HashMap<String, Object>();

			resultMap.put("list", mberManageService.selectTest());
