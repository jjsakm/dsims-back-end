...
public class PrvcFileHldPrstInsertRequestDto implements Serializable {
	...
	@Schema(description = "doc_clsf_no", example = "", hidden = true)
	private String docClsfNo;
	
	@Schema(description = "prvc_file_hld_prst_no", example = "", hidden = true)
	...
	@Schema(description = "rgtr_id", example = "", hidden = true)
	private String rgtrId;
	
	@Schema(description = "mdfr_id", example = "", hidden = true)
